...
public class Conversion {
    ...
    public static void main(String[] args) {
        ...
        if (userInputMetricOption == 1) {
            ...
            System.out.println("Output: " + userInput + " f equals to " + output + " k");
        } else if (userInputMetricOption == 13)  {
            //13 : This part is executed
            // 1l = 4.17 cups 
            double output = 4.17 * userInput;
            System.out.println("Output: " + userInput + " l equals to " + output + " cups");
        } else if  (userInputMetricOption == 14) {
            //14 : This part is executed
            //1cup= 0.24l 
            double output = 0.24 * userInput;
            System.out.println("Output: " + userInput + " 1 cup equals to " + output + " l");
        } else {
